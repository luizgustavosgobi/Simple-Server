...
import br.com.luizgustavosgobi.simpleServer.core.converter.ConverterContext;
...
public class StringToHttpCoded implements ChannelHandler {
    ...
    @Override
    public RequestEntity<?> channelRead(ConverterContext ctx, Object msg) throws Exception {
    ...
    @Override
    public String channelWrite(ConverterContext ctx, Object msg) throws Exception {
