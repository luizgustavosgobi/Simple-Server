...
import br.com.luizgustavosgobi.simpleServer.exceptions.TypeMismatchException;
...
public record FormData(String boundary, Map<String, Object> values) implements BodyData {
